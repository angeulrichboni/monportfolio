    ...
    <div className="space-y-8">
      ...
      <ul className="grid gap-3 sm:grid-cols-3 text-sm max-w-4xl mx-auto">
        <li className="card p-4 text-center">
          <div className="text-xs uppercase tracking-wide" style={{ color: "var(--color-muted)" }}>Spécialisation</div>
          <div className="mt-1 font-medium" style={{ color: "var(--color-foreground)" }}>Big Data / Data Engineering</div>
        </li>
        <li className="card p-4 text-center">
          <div className="text-xs uppercase tracking-wide" style={{ color: "var(--color-muted)" }}>Centres d’intérêt</div>
          <div className="mt-1 font-medium" style={{ color: "var(--color-foreground)" }}>ETL, Data Lake, DW, MLOps</div>
        </li>
        <li className="card p-4 text-center">
          <div className="text-xs uppercase tracking-wide" style={{ color: "var(--color-muted)" }}>Localisation</div>
          <div className="mt-1 font-medium" style={{ color: "var(--color-foreground)" }}>Tunisie</div>
        </li>
      </ul>
      ...
      <div className="card p-6">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-3">
          <div className="rounded-lg border border-gray-200 dark:border-gray-800 p-4">
            ...
            <div className="text-sm" style={{ color: "var(--color-muted)" }}>TEK-UP — 2023–2026</div>
          ...
          <div className="rounded-lg border border-gray-200 dark:border-gray-800 p-4">
            ...
            <div className="text-sm" style={{ color: "var(--color-muted)" }}>ESATIC — 2019–2022</div>
          ...
          <div className="rounded-lg border border-gray-200 dark:border-gray-800 p-4">
            ...
            <div className="text-sm" style={{ color: "var(--color-muted)" }}>Lycée — 2018–2019</div>
